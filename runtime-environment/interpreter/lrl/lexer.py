...
class Lexer:
    ...
    def make_identifier(self):
        ...
        # Bool literals are case-insensitive: True / False / true / false
        if lower in ('true', 'false'):
            return Token(TT_BOOL, lower == 'true', pos_start, self.pos.copy())

        tok_type = TT_KEYWORD if lower in KEYWORDS else TT_IDENTIFIER
        return Token(tok_type, lower if tok_type == TT_KEYWORD else id_str, pos_start, self.pos.copy())
